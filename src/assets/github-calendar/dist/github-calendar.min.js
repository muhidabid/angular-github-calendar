...
var cssFile = document.createElement('link');
    ...
    cssFile.href = "./github-calendar-responsive.css";  // or path for file {themes('/styles/mobile.css')}
    ...
    return function r(o, a, u) {
        ...
        1: [function(e, t, n) {
            ...
            t.exports = function(d, e, f) {
                d = g(d), (f = f || {}).summary_text = f.summary_text || 'Summary of pull requests, issues opened, and commits made by <a href="https://github.com/' + e + '" target="blank">@' + e + "</a>", f.cache = 1e3 * (f.cache || 86400), !1 === f.global_stats && (d.style.minHeight = "175px");
                var n = {
                ...
                return f.proxy = f.proxy || function(e) {
                    ...
                    function l() {
                        return f.getCalendar(e).then(function(e) {
                            var t, r, n = document.createElement("div"),
                            ...
                            }), e.appendChild(t), e.appendChild(u), e.appendChild(n)), d.innerHTML = e.innerHTML, !0 === f.tooltips && (a = d, (r = document.createElement("div")).classList.add("day-tooltip"), a.appendChild(r), a.querySelectorAll(".js-calendar-graph-svg rect.ContributionCalendar-day").forEach(function(e) {
            ...
            t.exports = function(e) {
                ...
                return e.split("\n").slice(2).map(function(e) {
                    ...
                    t && (n = {
                        ...
                        count: e,
                        level: t
                    }, 0 === o.current_streak && (o.current_streak_range[0] = n.date), n.count ? (++o.current_streak, o.last_year += n.count, o.last_contributed = n.date, o.current_streak_range[1] = n.date) : (r(), o.current_streak = 0), a.push(n), o.days.push(n))
                }), r(), o
            }
        }, {
                    ...
                    value: function(e, t) {
                        ...
                        do {
                            var r = e.match(this.re),
                                r = r && r[1],
                                o = r || e.charAt(0)
                        } while (n += r ? r = "function" == typeof(r = this.obj[r]) ? r.apply(this, t) : r : o, e = e.substring(o.length));
                        return n
                    }
                }]), s);
        ...
        13: [function(e, t, n) {
            t.exports = function(e, t, n) {
                ...
                if (0 !== o) {
                    ...
                    for (void 0 !== n && (o = n < 0 ? n + o : n); o-- > a;) r[o - a] = e[o]
                }
                return r
            }
        }, {}]
